        ...
        <?php else: ?>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <div><?php echo format_size($info[$i]['Memory']['used_memory']) ?></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div><?php echo format_ago($info[$i]['Server']['uptime_in_seconds']) ?></div>
                    </td>
                </tr>
...
<p>
    <a href="https://github.com/negami/phpRedisAdmin" target="_blank">phpRedisAdmin on GitHub fork @negami</a>
</p>
<p>
